...
bool MP4File::CreateMetadataAtom(const char* name)
{
    ...
    else if (memcmp(name, "aART", 4) == 0) /* STEP */
    {
        pMetaAtom->SetFlags(0x1);
	}
...
bool MP4File::GetMetadataDisk(u_int16_t* disk, u_int16_t* totalDisks)
{
    ...
    *totalDisks = 0;
    ...
    if (valSize != 8 && valSize != 6/* Apple iTunes?? */)
        return false;
...
bool MP4File::SetMetadataGroup(const char* value)
{
...
bool MP4File::GetMetadataGroup(char** value)
{
    unsigned char *val = NULL;
    u_int32_t valSize = 0;
...
/* STEP */
bool MP4File::SetMetadataAlbumArtist(const char* value)
{
    const char *s = "moov.udta.meta.ilst.aART.data";
    MP4BytesProperty *pMetadataProperty = NULL;
    MP4Atom *pMetaAtom = NULL;
...
bool MP4File::GetMetadataAlbumArtist(char** value)
{
    unsigned char *val = NULL;
    u_int32_t valSize = 0;
    const char *s = "moov.udta.meta.ilst.aART.data.metadata";
    GetBytesProperty(s, (u_int8_t**)&val, &valSize);
