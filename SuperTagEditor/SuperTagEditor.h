...
#define PROG_NAME		"STEP"/*"SuperTagEditor"*/	// プログラム名
#define PROG_VERSION	"1.03"/*"2.00β7"*/			// バージョン
#define PROG_NAME_ORG		"SuperTagEditor"	// プログラム名
#define PROG_VERSION_ORG	"2.00β7"			// バージョン
...
extern	CString		g_strPluginIniFileName; /* 2006.06.19 */
