...
unsigned short zen2han(unsigned short c, int flag)
{
	...
	if (flag & CONV_KATA) {
		...
		static const unsigned char *hira = (const unsigned char *)
			"‚Ÿ‚ ‚¡‚¢‚£‚¤‚¥‚¦‚§‚¨‚©‚«‚­‚¯‚±‚³‚µ‚·‚¹‚»‚½‚¿‚Á‚Â‚Ä‚Æ‚È‚É‚Ê‚Ë‚Ì"
			"‚Í‚Ğ‚Ó‚Ö‚Ù‚Ü‚İ‚Ş‚ß‚à‚á‚â‚ã‚ä‚å‚æ‚ç‚è‚é‚ê‚ë‚í‚ğ‚ñ\0";
		// ‚Ğ‚ç‚ª‚È
...
{
	// MS-IME2000‚Å‚Í‚¤‚Ü‚­“®‚¢‚½‚ªAATOK16‚Å‚Í‚¾‚ßB’PŒê’PˆÊ‚Å‚ ‚ê‚Î‚Å‚«‚é...
...
void conv_romaji(HWND hwnd, unsigned char *str, unsigned char *sRomaji)
{
	static const char *romaji[] = {
		...
		"‚Ğ‚á", "HYA", "‚Ğ‚ã", "HYU", "‚Ğ‚å", "HYO",
		"‚İ‚á", "MYA", "‚İ‚ã", "MYU", "‚İ‚å", "MYO",
		...
		"‚Í", "HA", "‚Ğ", "HI", "‚Ó", "FU", "‚Ö", "HE", "‚Ù", "HO",
		"‚Ü", "MA", "‚İ", "MI", "‚Ş", "MU", "‚ß", "ME", "‚à", "MO",
		"‚â", "YA", "‚ä", "YU", "‚æ", "YO",
...
void main(void)
{
	...
	const unsigned char *s1 =
		/* 0123456789ABCDEF		        ‚O‚P‚Q‚R‚S‚T‚U‚V‚W‚X‚`‚a‚b‚c‚d‚e */
		  ...
		  "=<>\\"	/* 216X:€‚ƒ„…†‡ˆ‰Š‹Œ */
		  "$%#&*@\n"	/* 217X:‘’“”•–—˜™š›œ   */
		   "§±¨²©³ª´«µ¶Ş·Ş¸Ş"	/* 252X:@ƒ@ƒAƒBƒCƒDƒEƒFƒGƒHƒIƒJƒKƒLƒMƒN */
		  "¹ŞºŞ»Ş¼Ş½Ş¾Ş¿ŞÀŞ\n"	/* 253X:ƒOƒPƒQƒRƒSƒTƒUƒVƒWƒXƒYƒZƒ[ƒ\ƒ]ƒ^ */
		  "ÁŞ¯ÂŞÃŞÄŞÅÆÇÈÉÊŞ"	/* 254X:ƒ_ƒ`ƒaƒbƒcƒdƒeƒfƒgƒhƒiƒjƒkƒlƒmƒn */
		  "ÊßËŞËßÌŞÌßÍŞÍßÎŞÎßÏĞ\n"	/* 255X:ƒoƒpƒqƒrƒsƒtƒuƒvƒwƒxƒyƒzƒ{ƒ|ƒ}ƒ~7F */
		  "ÑÒÓ¬Ô­Õ®Ö×ØÙÚÛÜ"	/* 256X:ƒ€ƒƒ‚ƒƒƒ„ƒ…ƒ†ƒ‡ƒˆƒ‰ƒŠƒ‹ƒŒƒƒƒ */
		  "¦İ";				/* 257X:ƒƒ‘ƒ’ƒ“ƒ”ƒ•ƒ– */
