...
// Write Tag data, returns 0 for success, 1 for partial success, 2 for error
int   WriteNoTag    ( Reader* fp, StreamInfo* Info );                         // remove all tags
int   WriteID3V1Tag ( Reader* fp, StreamInfo* Info );                         // write ID3v1.0 / 1.1 tag
int   WriteAPE1Tag  ( Reader* fp, StreamInfo* Info );                         // write APE tag version 1.0
int   WriteAPE2Tag  ( Reader* fp, StreamInfo* Info );                         // write APE tag version 2.0
int   WriteAutoTag  ( Reader* fp, StreamInfo* Info );                         // write most suitable tag
int   WriteTag      ( Reader* fp, StreamInfo* Info );                         // write tag
...
int   ConvertANSIToUTF8 ( const char* ansi, char* utf8 );                   // convert Windows ANSI to UTF-8
int   ConvertUTF8ToANSI ( const char* utf8, char* ansi );                   // convert UTF-8 to Windows ANSI

// Calculates start of file
long  JumpID3v2     ( Reader* fp );
