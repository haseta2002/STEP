...
{
	// /* 2006.05.15 */((CButton *)GetDlgItem(IDC_CH_CONF_CONV_MP3   ))->SetCheck(TRUE);
	// /* 2006.05.15 */((CButton *)GetDlgItem(IDC_CH_CONF_CONV_RMP   ))->SetCheck(TRUE);
	// /* 2006.05.15 */((CButton *)GetDlgItem(IDC_CH_CONF_CONV_ID3V2 ))->SetCheck(TRUE);
