...
#define STEP_API_VERSION 0x000500 /* STEP 045 */
...
enum COLUMNTYPE {
	...
	COLUMN_ALBUM_ARTIST,	// アルバムアーティスト /* STEP 042 */
	COLUMN_WRITER,			// 作詞者 /* STEP 043 */
	COLUMN_DISK_NUMBER,		// ディスク番号 /* STEP 045 */
...
case COLUMN_ALBUM_ARTIST:	// アルバムアーティスト
case COLUMN_WRITER:			// 作詞者
...
enum FIELDTYPE {
	...
	FILED_WRITER_SI,				// 作詞者 /* STEP 043 */
	FIELD_DISK_NUMBER_SI,			// ディスク番号 /* STEP 045 */
