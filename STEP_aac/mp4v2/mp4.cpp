...
extern "C" bool MP4SetMetadataGroup(MP4FileHandle hFile,
				    const char* value)
{
  if (MP4_IS_VALID_FILE_HANDLE(hFile)) {
    try {
      return ((MP4File*)hFile)->SetMetadataGroup(value);
    }
    catch (MP4Error* e) {
      PRINT_ERROR(e);
      delete e;
...
extern "C" bool MP4GetMetadataGroup(MP4FileHandle hFile,
				    char** value)
{
  if (MP4_IS_VALID_FILE_HANDLE(hFile)) {
    try {
      return ((MP4File*)hFile)->GetMetadataGroup(value);
    }
    catch (MP4Error* e) {
      PRINT_ERROR(e);
      delete e;
				     ...
				     const char* value)
{
  if (MP4_IS_VALID_FILE_HANDLE(hFile)) {
    try {
      return ((MP4File*)hFile)->SetMetadataAlbumArtist(value);
    }
    catch (MP4Error* e) {
      PRINT_ERROR(e);
      delete e;
				     ...
				     char** value)
{
  if (MP4_IS_VALID_FILE_HANDLE(hFile)) {
    try {
      return ((MP4File*)hFile)->GetMetadataAlbumArtist(value);
    }
    catch (MP4Error* e) {
      PRINT_ERROR(e);
      delete e;
