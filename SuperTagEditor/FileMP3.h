...
///* Conspiracy 198 */	CString strBitRate;					// ビットレート
	...
	CString	strDiskNumberSI;			// ディスク番号 /* STEP 045 */
...
//	static	bool	GetMpegInfo(const char *, MPEG_INFO *);
	...
	static	bool	SetFileTimeStamp(const char *sFileName, COleDateTime& ctime, COleDateTime& mtime); /* STEP 044 */
	static	bool	GetFileTimeStamp(const char *sFileName, COleDateTime& ctime, COleDateTime& mtime); /* STEP 044 */
